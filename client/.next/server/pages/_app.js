...
App.getInitialProps = async ({
  ...
  const pageProps = await ((_Component$getInitial = Component.getInitialProps) === null || _Component$getInitial === void 0 ? void 0 : _Component$getInitial.call(Component, ctx)); // pageProps를 props로 넘김 => 위에서 Component와 함께 받아 Component 안에 props로 넣어줌
